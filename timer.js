...
let displayBanner = async () => {
    await showBanner("COUNTDOWN  TIMER", "You can set your count down timer according to the instructions below.");
};
